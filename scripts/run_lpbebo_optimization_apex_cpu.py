...
OUTPUT_PATH = "./results/lpbebo_sorbes_cpu_test"
EVALUATION_BUDGET = 2800  # Reduced for quick CPU test

# Pairwise similarity potential filtering parameters
TOP_P = 0.5  # nucleus filtering threshold
...
# Quick test: run only one protein with 1 trial
proteins = {
    "middle-1": ("FLYKWWIRIGRLKL", 1),  # Just 1 trial for CPU test
}
...
print(f"\n✓ LPBEBO SORBES+mutang++ CPU test completed successfully!")
