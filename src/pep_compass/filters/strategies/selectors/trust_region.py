...
from pep_compass.filters.base import Filter, Selector
...
from pep_compass.optimization.state import TrustRegionState


@FilterManager.register("trust_region")
class TrustRegionSelector(Selector):
...
class TrustRegionUpdater(Filter):
