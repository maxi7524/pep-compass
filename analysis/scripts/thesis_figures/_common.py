...
notebooks (count_mic_changes / karol_mutational_signature_analysis / final_wasserstein)
and every figure is written as a real vector PDF into the thesis ``figures/`` folder.
"""
